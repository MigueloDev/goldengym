...
export default function CreatePathology() {
    ...
    const breadcrumbs = pathologiesBreadcrumbs.create();

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Nueva Patología" />
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight">Nueva Patología</h1>
                                <p className="text-muted-foreground">
                                    Registra una nueva patología en el sistema
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-end space-x-4">
                            ...
                            <Button type="submit" disabled={processing}>
                                ...
                                {processing ? 'Guardando...' : 'Guardar Patología'}
                            </Button>
                        </div>
                    </form>
                </div>
